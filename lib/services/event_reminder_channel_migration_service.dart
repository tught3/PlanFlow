...
class EventReminderChannelMigrationService {
  const EventReminderChannelMigrationService({
  ...
  Future<bool> migrateFutureEventRemindersIfNeeded(String userId) async {
    ...
    try {
      ...
      final futureEvents = (await _repository.listEvents(
      ...
      debugPrint('Event reminder channel migration failed: $error');
  ...
  static String _migrationKey(String userId) {
    return 'event_reminder_channel_migration:$userId:'
